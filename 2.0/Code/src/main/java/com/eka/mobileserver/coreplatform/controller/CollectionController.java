...
import static com.eka.mobileserver.constants.UriConstants.COLLECTIONS_ID_COLUMN_NAME_MAP_URI;
import static com.eka.mobileserver.constants.UriConstants.COLLECTIONS_QUICK_EDIT_INFO_URI;
...
@RestController
@RequestMapping("${api.context}/collections")
